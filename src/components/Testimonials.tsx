...
export default function PersonalizedPlans() {
  ...
  return (
    <section
      id="plans"
      className="py-20 bg-white text-center w-full scroll-mt-40"
    >
      <div className="max-w-screen-xl mx-auto px-6">
        ...
        >
          Pick a plan that suits your commitment. All plans include phone +
          email support — choose longer plans for more sessions, recipes, and
          priority attention.
        </motion.p>
              ...
              <CardContent className="p-6 flex flex-col justify-between h-full">
                <div>
                  ...
                  <div className="bg-[#13ad9d]/10 border-l-4 border-[#13ad9d] pl-3 py-3 mb-4 text-left">
                    ...
                    {p.highlight && (
                      <p className="text-sm text-[#13ad9d] font-medium mb-2">
                        {p.highlight}
                      </p>
                    )}
                    <p className="text-2xl font-bold text-[#13ad9d]">
                      {p.priceLabel}
                    </p>
                  </div>
        ...
        <div className="mt-8 text-sm text-gray-500">
          <p>
            All prices include taxes. Sessions must be scheduled in advance. For
            corporate/group plans or custom bundles, contact{" "}
            <a
